        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="#concept" className="hover:text-gold transition-colors">
                  Conceito
                </a>
              </li>
              <li>
                <a href="#experiences" className="hover:text-gold transition-colors">
                  Experiências
                </a>
              </li>
              <li>
                <a href="#reservation" className="hover:text-gold transition-colors">
                  Reservas
                </a>
              </li>
              <li>
